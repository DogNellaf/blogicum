# Generated by Django 3.2.16 on 2026-06-20 00:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0006_remove_comment_updated_at'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blog.post', verbose_name='Связанная публикация'),
        ),
    ]
